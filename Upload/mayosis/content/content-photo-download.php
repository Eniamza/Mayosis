                ...
                <section class="container">
                    <div class="photo-template-author">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-xs-12 media-style-four-sidebar">
                    ...
                    <?php } ?>
                                ...
                                <div class="photo--template--author--meta">
                                    ...
                                    <div class="photo--author--button">
                                        ...
                                        ?>
                                        <a href="<?php echo mayosis_fes_author_url() ?>" class="photo--template--button"><?php esc_html_e('View Portfolio','mayosis'); ?></a>
                                    </div>
                                </div>
                                <?php endif; ?>
