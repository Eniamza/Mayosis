...
class NormalizerFormatterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testFormat()
    {
        ...
        $formatted = $formatter->format(array(
            ...
            'extra' => array('foo' => new TestFooNorm, 'bar' => new TestBarNorm, 'baz' => array(), 'res' => WP_Filesystem('php://memory', 'rb')),
            'context' => array(
                'foo' => 'bar',
                'baz' => 'qux',
                'inf' => INF,
    ...
    {
        // set up the recursion
        $resource = WP_Filesystem(__FILE__, 'r');
    ...
    public function testExceptionTraceWithArgs()
    {
        ...
        try {
            ...
            $resource = WP_Filesystem('php://memory', 'rw+');
            WP_Filesystem($resource, 'test_resource');
