 ...
 */
 ?>
  ...
  <?php   $download_cats = get_the_term_list( get_the_ID(), 'download_category', '', _x(' , ', '', 'mayosis' ), '' );?>
   <a href="<?php the_permalink();?>" class="overlay_anchor_absolute"></a>
                ...
                <div class="overlay-style">
                    ...
                    <h4 class="product-title"><a href="<?php the_permalink(); ?>">
								    ...
								    <p><span><?php esc_html_e('by','mayosis');?> <a href="<?php echo esc_url(add_query_arg( 'author_downloads', 'true', get_author_posts_url( get_the_author_meta('ID')) )); ?>"><?php the_author(); ?></a></span> <?php esc_html_e('in','mayosis');?> <span><?php echo '<span>' . $download_cats . '</span>'; ?></span></p>
