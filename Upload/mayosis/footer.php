    ...
    <div class="copyright-columned">
        <div class="copyright-text text-left col-md-6 col-xs-12">
			...
			<?php echo  wp_kses($footercopyrighttxt,$allowed_html); ?>
				<?php else:?>
				<p class="copyright-text">© Copyright 2020 I <a href="https://teconce.com/item/mayosis-digital-marketplace-wordpress-theme/" target="_blank">Mayosis</a> Theme</p>
				<?php endif; ?>
        </div>
...
<?php else : ?>
	<div class="text-center copyright-full-width-text">
			...
			<?php echo  wp_kses($footercopyrighttxt,$allowed_html); ?>
				<?php else:?>
				<p class="copyright-text text-center">© Copyright 2020 I Mayosis Theme by <a href="https://teconce.com/">TecOnce</a> I All Rights Reserved I Powered by <a href="https://wordpress.org/">WordPress</a></p>
				<?php endif; ?>
		</div>
	<?php endif; ?>
