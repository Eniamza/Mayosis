...
<div class="fes_dashboard_menu">
    <div class="logo-dashboard hidden-xs hidden-sm">
...
<nav class="fes-vendor-menu mayosis-frontend-menus hidden-xs hidden-sm">
	<ul>
...
<div class="hidden-md hidden-lg mobile-dashboard-menu">
